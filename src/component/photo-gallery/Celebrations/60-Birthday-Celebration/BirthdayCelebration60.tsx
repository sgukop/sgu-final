...
return (
    <section className="tl-4-innovs pt-100 pb-100">
      <div className="container">
        ...
        <h6 className="tl-8-feature-title">60th Birthday Celebration of Hon. President Mr. Sanjayji Ghodawat in the presence of Mr. Ayushmann Khurrana on 28th February 2025 at Sanjay Ghodawat University Campus</h6>
