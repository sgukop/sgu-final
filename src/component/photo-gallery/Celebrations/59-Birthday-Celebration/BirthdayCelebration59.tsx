...
return (
    <section className="tl-4-innovs pt-100 pb-100">
      <div className="container">
        ...
        <h6 className="tl-8-feature-title">59th Birthday Celebration of Hon. President Mr. Sanjayji Ghodawat in the presence of Mr. Prasad Oak (marathi film actor) on 28th February 2023 at Sanjay Ghodawat University Campus</h6>
