                ...
                <div className="row gy-4 gy-sm-5 tl-1-blogs-row">
                    <div className="col-lg-4">
                        <div className="tl-1-blog flex flex-col justify-center h-full">
                            <img src="assets/images/photo-gallery/national-festivals/republic-day-2018/6.jpg" alt="National Festivals Image" className="tl-1-blog-img-new"/>
                                <div className="tl-1-blog-txt">
                                    <h4 className="tl-1-blog-title"><Link href="/photoes-republic-day-2018">Republic Day 2018</Link></h4>
                                    <Link href="/photoes-republic-day-2018" className="tl-1-blog-btn">Continue Reading <i className="fa-regular fa-arrow-right"></i></Link>
                                </div>
                        </div>
                    </div> 
