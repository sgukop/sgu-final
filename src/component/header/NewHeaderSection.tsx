...
const NewHeaderSection = () => {
    ...
    // Converted the YouTube Short URL to its embed version
    const videoEmbedUrl = "https://www.youtube.com/embed/6YuWY_kgy24?autoplay=1"; 

    return (
        <>
        {/*
          POPUP MODIFICATION: Full page overlay with embedded video
        */}
        {showPopup && (
        ...
        {/* Existing Header Logo and Navigation Content */}
                                    ...
                                    <ul className="dropdown-menu1 hidden absolute left-[100%] bg-white top-[10px] py-2 border-t-4 border-[#f4b826]">
                                        ...
                                        <li 	className="dropdown2 relative py-[3px] px-4"><a className="font-normal text-[15px] hover:text-[#f4b826] flex justify-between">School of Life Sciences <i className="fa-regular fa-angle-right"></i></a>
                                            <ul className="dropdown-menu2 hidden absolute left-[100%] bg-white top-[10px] py-2 border-t-4 border-[#f4b826]">
                                                ...
                                                {/* Removed the duplicate B.Sc. (Biotechnology) link */}
                                            </ul>
                                        </li>
        ...
        <Marquee speed={100} gradient={false} pauseOnHover className="flex m-2">
            <sup><img src="assets/images/new-icon-image.gif" alt="New icon"/></sup>
            ...
            <sup><img src="assets/images/new-icon-image.gif" alt="New icon"/></sup>
            <a href="https://www.sguk.ac.in/our-recruiters" target="_blank" className="text-[#800000] text-bold hover:text-[#212f64] mr-6">Training and Placement Details in Academics Year 	2024-25 </a>
