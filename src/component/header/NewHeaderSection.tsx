...
const NewHeaderSection = () => {
  ...
  const [isPopupOpen, setIsPopupOpen] = useState(false);
    ...
    <sup><img src="assets/images/new-icon-image.gif"/></sup>
      <a href="https://manage-api.sguk.ac.in/api/assets/6a34e7e4a269d0dd77bf4681" target="_blank" className="text-[#800000] text-bold hover:text-[#212f64] mr-6">Brands of Kolhapur Recognition for SGU</a>
