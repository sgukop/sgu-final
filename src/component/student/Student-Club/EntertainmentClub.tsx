  ...
  return (
    <section className="tl-1-teachers pt-100 pb-100">
        <div className="container">
            <h2 className="tl-9-section-title py-4 rounded-tl-[40px] rounded-br-[40px] w-fit px-8 bg-[#4f70b6] font-bold text-white mx-auto mb-50">Entertainment Club</h2>
                            ...
                            <div className="col-lg-4 col-sm-6">
                                <div className="tl-2-blog tl-2-course">
                                    <div className="tl-2-course-img">
                                        <img src="assets/images/student/officer/female.jpg" alt="Profile Image"/>
                                    </div>

                                    <div className="tl-2-course-txt">
                                        <h4 className="tl-1-course-title tl-2-course-title"><strong>Faculty Coordinators</strong></h4>
                                        <p className="tl-2-course-descr"><strong>Ms. Priyanka Patil</strong></p>
                                        <p className="tl-2-course-descr"><strong>Mobile No.7506968979</strong></p>
                                    </div>
                                </div>
                            </div>
...
export default EntertainmentClub