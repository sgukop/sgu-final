    ...
    <section className="tl-inner-courses pb-60 pt-130 bg-coffee">
      <div className="container">
        <div className="tl-2-section-heading d-flex justify-content-center" style={{ width: '100%' }}>
          <h3 className="tl-2-section-title py-4 rounded-tl-[40px] rounded-br-[40px] w-fit px-2 bg-[#4f70b6] font-bold text-white mx-auto mb-50" style={{ fontSize: '44px' }}>Our Global Connections - Foreign University Collaborations</h3>
        </div>
            ...
            <div className="col-lg-4 col-sm-6" key={item.id}>
              <div className="tl-1-course" style={index < 3 ? { minHeight: '585px' } : { minHeight: '470px' }}>
                ...
                <div className="tl-1-course-txt">
                  <h4 className="tl-1-course-title" style={{ fontSize: '20px', marginBottom: '18px',fontWeight:"bold",color:"#4f70b6"}}>{item.title}</h4>
