...
import NavLinks from '@/component/faculty/School-of-Chemical-Sciences/Navlinks';
import BtechSyllabus from './bscSyllabus';
import MtechSyllabus from './mscSyllabus';
  ...
  return (
      <div className="pt-100 pb-100">
          ...
          <h2 className="tl-9-section-title mb-50">Curriculum Structure and Syllabus</h2>
              <div className="row">
                    <MenuList dept="Aerospace Engineering" subMenu={NavLinks}/>
