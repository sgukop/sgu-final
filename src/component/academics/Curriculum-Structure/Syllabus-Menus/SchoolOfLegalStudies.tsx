...
const SchoolOfLegalStudies = ({sectionStyle,pageStyle,categoryStyle} : Props) => {
  return (
                ...
                <div data-spy="scroll" className="scrollspy-example z-depth-1 mt-4 p-3 mb-4 col-lg-8 col-md-6 col-sm-12 dept-content" data-target="#menu-navbar" data-offset="0">
                    <div className={`row ${pageStyle}-categories-row`}>
                        <div className="col-lg-6 col-md-12 col-12 col-xxs-12">
                            <Link href="/legalstudies-syllabus" className={`tl-3-single-program ${categoryStyle}`}>
                                <h6 className="tl-3-single-program-title">Legal Studies(Law) Syllabus</h6>
...
export default SchoolOfLegalStudies