...
import BtechAIMLSyllabus from './BtechAIMLSyllabus';
import MtechAIMLSyllabus from './MtechAIMLSyllabus';
import NavLinks from '@/component/faculty/Artificial-Intelligence-Machine-Learning/Navlinks';
