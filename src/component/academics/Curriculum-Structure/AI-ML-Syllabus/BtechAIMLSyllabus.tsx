    ...
    <div>
        <Table responsive className="governing-table">
          ...
          <tbody>
             ...
             <tr>
                  <td><p>B.Tech Third Year R23 Syllabus</p></td>
                  <td><Link rel="noopener noreferrer" className="tl-def-btn-2" target="_blank" href="https://manage-api.sguk.ac.in/api/assets/6966122d2707d1e5bb924222">B.Tech Third Year R23 Syllabus <i className="fa-regular fa-arrow-right-long"></i></Link></td>
             </tr>
             <tr>
                  <td><p>B.Tech Second Year Syllabus</p></td>
                  <td><Link rel="noopener noreferrer" className="tl-def-btn-2" target="_blank" href="https://manage-api.sguk.ac.in/api/assets/696611c62707d1e5bb92421d">B.Tech Second Year Syllabus <i className="fa-regular fa-arrow-right-long"></i></Link></td>
             </tr>
             <tr>
