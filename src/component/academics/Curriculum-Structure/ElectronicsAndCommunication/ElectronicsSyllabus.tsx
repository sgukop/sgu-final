...
import NavLinks from '@/component/faculty/Electronics-And-Communication-engineering/Navlinks';
import MenuList from '@/component/faculty/Reusable-components/MenuList';

const ElectronicsSyllabus = () => {
  return (
                            ...
                            <div data-spy="scroll" className="scrollspy-example z-depth-1 mt-4 p-3 mb-4 col-lg-8 col-md-6 col-sm-12 dept-content" data-target="#menu-navbar" data-offset="0"> 
                                <Tab.Container id="myTab" defaultActiveKey="overview-tab">
                                    <Nav className="nav-tabs tl-course-details-navs">
                                        <Nav.Item>
                                            <Nav.Link eventKey="overview-tab">B. Tech Electronics & Communication Engineering</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="curriculum-tab">M. Tech Electronics & Communication Engineering</Nav.Link>
                                        </Nav.Item>
                                    </Nav>
...
export default ElectronicsSyllabus