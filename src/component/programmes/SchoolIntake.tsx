...
const SchoolIntake = () => {
  return (
    ...
    <div className="tl-event-details-area tl-course-details-curriculum">
      ...
      <caption className="captionnn dark-mode-white-color">B.Tech First Year Academic Year 2024-25</caption>
          <thead>
              <tr>
      ...
      <Table bordered responsive className="governing-table">
      <caption className="captionnn dark-mode-white-color">B.Tech Direct Second Year Academic Year 2024-25</caption>
          <thead>
              <tr>
                  <th><p>Course Name</p></th>
                  <th><p>Intake</p></th>
          ...
          <tbody>
              <tr>
              <td><p>Aeronautical Engineering</p></td>
                    <td rowSpan={5} className="row-spannnnn">
                        <p>Lateral Entry 10%</p>
                        <p>+</p>
                        <p>Last Year Vacancy</p>
                        <p>=</p>
                        <p>Total DSE Seat Available</p>
                    </td>
              </tr>
              <tr>
                  <td><p>Civil Engineering</p></td>
      ...
      <Table bordered responsive className="governing-table">
      <caption className="captionnn dark-mode-white-color">M.Tech First Year Academic Year 2024-25</caption>
          <thead>
              <tr>
                  <th><p>Course Name</p></th>
                  <th><p>Intake</p></th>
    ...
    <div className="tl-event-details-area tl-course-details-curriculum">
      ...
      >
        <div className="accordion-body">
        <Table striped bordered responsive variant="light" className="governing-table">
      <caption className="captionnn dark-mode-white-color">B.Tech First Year Academic Year 2024-25</caption>
          <thead>
              <tr>
                  <th><p>Course Name</p></th>
