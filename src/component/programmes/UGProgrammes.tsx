        ...
        <div className="col-lg-12">
            ...
            <div className="tl-event-details-left">
                <div className="tl-event-details-key-content tl-event-details-area" style={{marginTop:'8px'}}>
                    <h4 className="tab-titleee dark-mode-white-color">Bachelor of Technology (B.Tech)</h4>
                       <ul className="tl-event-details-key-content-list phd-container">

                            <li className="dark-mode-white-color" >B.Tech. in Aeronautical Engineering</li>
                            <li className="dark-mode-white-color" >B.Tech. in Civil Engineering</li>
                            <li className="dark-mode-white-color" >B.Tech in Electronics & Communication Engineering</li>
                            <li className="dark-mode-white-color" >B.Tech in Computer Science and Engineering</li>
                            <li className="dark-mode-white-color" >B.Tech in Artificial Intelligence and Machine Learning (A.I.M.L)
                            </li>
