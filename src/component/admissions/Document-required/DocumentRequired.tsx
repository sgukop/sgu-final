            ...
            <div className="row tl-event-details-row g-0">
                <div className="col-lg-12">
                    ...
                    <div className="tl-event-details-left">
                        ...
                        <div className="tl-event-details-key-content tl-event-details-area">
                            <h4 className="dark-mode-white-color mb-30">For First Year M. Tech / MBA / M. Sc / M.C.A. Admissions</h4>
                               <ul className="tl-event-details-key-content-list phd-container">
                        ...
                        <div className="tl-event-details-left mt-30">
                        <div className="tl-event-details-key-content tl-event-details-area">
                            <h4 className="dark-mode-white-color mb-30">For First Year BBA / B. Com / BA / B.C.A / D. Pharmacy/B.Sc/B.Sc Food Science and Technology/ B.M.L.T. Admissions</h4>
                               <ul className="tl-event-details-key-content-list phd-container">
                                    <li>SSC Marksheet</li>
                                    <li>HSC Marksheet</li>
                        ...
                        <div className="tl-event-details-left mt-30">
                        <div className="tl-event-details-key-content tl-event-details-area">
                            <h4 className="dark-mode-white-color mb-30">For First Year B.Design</h4>
                               <ul className="tl-event-details-key-content-list phd-container">
