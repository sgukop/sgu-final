                    ...
                    <div className="col-md-12 col-lg-4 col-xxs-12 col-10">
                     ...
                     <div className="col-md-12 col-lg-4 col-xxs-12 col-10">
                        <div className="tl-1-course-new">
                            ...
                            <div className="tl-1-course-txt">
                                <h4 className="tl-1-course-title-new mt-30">Mrs.Savita Prakash Charane</h4>
                                <p className="tl-1-course-author-new dark-mode-white-color">Teaching Assistant</p>
                                <Link href="https://manage-api.sguk.ac.in/api/assets/674ede474b17e19d8f3617c1" rel="noopener noreferrer" target="_blank" className="tl-3-def-btn"> Profile </Link>
                            </div>
                        </div>
                    </div>   
