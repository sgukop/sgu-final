...
import ChemicalDeptTestimonials from "./ChemicalDeptTestimonials";
interface Props {
  style: string;
  array: ArrayItems[];
...
const ChemicalDeptAlumni:React.FC<Props> = ({style,array}) => {
            ...
            <div className="row">
                <MenuList dept="School of Management" subMenu={NavLinks} />
                    <div data-spy="scroll" className="scrollspy-example z-depth-1 mt-4 p-3 mb-4 col-lg-9 col-md-6 col-sm-12 dept-content" data-target="#menu-navbar" data-offset="0">
                      ...
                      <div className="col-lg-12">
                        <Table bordered responsive className="governing-table">
                          ...
                          <tbody>
                            <tr>
                              <td><p>1</p></td>
                              <td><p>Eureka Kadlas</p></td>
                              <td><p>B.Sc. Chemistry, 2025-26</p></td>
                              <td><p></p></td>
                            </tr>
                      ...
                      <div className="row">
                            <div className="col-lg-12">
                                <ChemicalDeptTestimonials padding='pt-50 pb-50' />
                            </div>
                      </div>
                </div>
            </div>
...
export default ChemicalDeptAlumni;
