...
import PSOs from "./BCADeptPEO/PSOs";
import PEOs from "./BCADeptPEO/PEOs";
import POs from "./BCADeptPEO/POs";

import MCAPSOs from "./MCADeptPEO/PSOs";
import MCAPEOs from "./MCADeptPEO/PEOs";
import MCAPOs from "./MCADeptPEO/POs";
   ...
   return (
    <section className="tl-14-about pt-100 pb-100" data-background="assets/images/tl-14/cta-bg.png">
          ...
          >
            ...
            <div className="col-lg-6">
                <div className="rounded-[20px] bg-[#4f70b6] p-6 text-white flex flex-col h-full">
                    ...
                    <h6 className="vision-info">"To deliver quality education in computer applications, fostering industry-ready professionals through competency-based learning and strategic collaborations with top institutes and organizations."
                    </h6>
                </div>
            </div>
            <div className="col-lg-6">
                <div className="rounded-[20px] bg-[#f26122] p-6 text-white flex flex-col h-full">
                    ...
                    <ul className="course-subjects">
		                    <li>To nurture software professionals with strong technical expertise, innovative ideas, entrepreneurial skills, and professional ethics.</li>
		                    <li>To deliver quality education through state-of-the-art facilities in Computer Applications.</li>
                        <li>To foster industry-institute collaboration to prepare students for real-world industry environments.</li>
                        <li>To engage in collaborative projects that enable long-term interaction with academia and industry.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div className="row outer-style mt-50">
              <h3 className="tl-event-details-area-title">PEO, PO and PSO (BCA)</h3>
              <div
                data-spy="scroll"
        ...
        <div className="row outer-style mt-50">
              <h3 className="tl-event-details-area-title">PEO, PO and PSO (MCA)</h3>
              <div
                data-spy="scroll"
                className="scrollspy-example z-depth-1 mt-4 p-3 mb-4 col-md-12"
                data-target="#menu-navbar"
