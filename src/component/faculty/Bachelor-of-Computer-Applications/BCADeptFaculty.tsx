                ...
                <div className="row g-4 g-xl-4 justify-content-center">
                    ...
                    <div className="col-md-12 col-lg-4 col-xxs-12 col-10">
                     ...
                     <div className="col-md-12 col-lg-4 col-xxs-12 col-10">
                        <div className="tl-1-course-new">
                            <div className="tl-1-course-img-new">
                                <img src="/assets/images/faculty-profile-photos/computer-applications/8. Mr. PRASHANT MITHARI.jpg" alt="Faculty Image"/>
                            </div>

                            <div className="tl-1-course-txt">
                                <h4 className="tl-1-course-title-new mt-30">Mr. Prashant Mithari</h4>
                                <p className="tl-1-course-author-new dark-mode-white-color">Assistant Professor</p>
                                <Link href="https://manage-api.sguk.ac.in/api/assets/674ff7484b17e19d8f36184a" rel="noopener noreferrer" target="_blank" className="tl-3-def-btn">Profile</Link>
                            </div>
                        </div>
                    </div>   
                    ...
                    <div className="col-md-12 col-lg-4 col-xxs-12 col-10">
                        <div className="tl-1-course-new">
                            <div className="tl-1-course-img-new">
                                <img src="/assets/images/faculty-profile-photos/computer-applications/10. Ms. SWATI PATIL.jpg" alt="Faculty Image"/>
                            </div>

                            <div className="tl-1-course-txt">
                                <h4 className="tl-1-course-title-new mt-30">Ms. Swati Sambhaji Patil</h4>
                                <p className="tl-1-course-author-new dark-mode-white-color">Assistant Professor</p>
                                <Link href="https://manage-api.sguk.ac.in/api/assets/674ff7744b17e19d8f361851" rel="noopener noreferrer" target="_blank" className="tl-3-def-btn">Profile</Link>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div className="col-md-12 col-lg-4 col-xxs-12 col-10">
                        <div className="tl-1-course-new">
                            ...
                            <div className="tl-1-course-txt">
                                <h4 className="tl-1-course-title-new mt-30">Mr. Omkar Salunkhe</h4>
                                <p className="tl-1-course-author-new dark-mode-white-color">Assistant Professor</p>
                                <Link href="#" rel="noopener noreferrer" target="_blank" className="tl-3-def-btn"> Profile </Link>
                            </div>
                        </div>
