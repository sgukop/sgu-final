...
const MLTDeptProfessionalBodies = () => {
   return (
                ...
                <div className="col-lg-12">
                       ...
                       <div className="tl-event-details-key-content tl-event-details-area">
                           <ul className="tl-event-details-key-content-list phd-container">
                                   ...
                                   <li><strong>MPC - </strong>Maharashtra Paramedical Council</li>
                                   <li><strong>ACS - </strong>American Chemical Society</li>
                                   <li><strong>RSB - </strong>Royal Society of Biology</li>
                              </ul>
                        </div>
...
export default MLTDeptProfessionalBodies
